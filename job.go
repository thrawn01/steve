...
type Job interface {
	...
	// Stop the job, returns an error if the context was canceled before the job was stopped
...
type Runner interface {
	// Run the provided job, returning an ID which can be used to track the status of a job.
